                        ...
                        <div class="box-body">
                          ...
                          <table id="maintable" class="table table-bordered table-striped">
                            ...
                            <tr>
                              ...
                              <td>{{ $tag->name }}</td>
                              <td>{{ $tag->slug }}</td>
                              <td><a class="btn btn-info btn-xs" href="{{route('tags.edit', $tag->id)}}">Edit</a></td>
                              <td><a class="btn btn-danger btn-xs deletebtn" href="{{route('tags.destroy', $tag->id)}}">Delete</a></td>
                            </tr>
                            @empty
                            @endforelse
                            </tbody>
